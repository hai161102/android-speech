...
import com.hprj.speechrecognizer.engine.BaseSpeechRecognitionEngine;
import com.hprj.speechrecognizer.engine.BaseTextToSpeechEngine;
import com.hprj.speechrecognizer.engine.DummyOnInitListener;
import com.hprj.speechrecognizer.engine.SpeechRecognitionEngine;
import com.hprj.speechrecognizer.engine.TextToSpeechEngine;
...
public class Speech {
     ...
     */
    public static Speech init(final Context context, Activity activity) {
        if (instance == null) {
     ...
     * @return speech instance
     */
    public static Speech init(final Context context, Activity activity, final String callingPackage) {
        if (instance == null) {
    ...
    public static Speech init(final Context context, Activity activity, final String callingPackage, TextToSpeech.OnInitListener onInitListener) {
        if (instance == null) {
    ...
    public static Speech init(final Context context, Activity activity, final String callingPackage, TextToSpeech.OnInitListener onInitListener, SpeechRecognitionEngine speechRecognitionEngine, TextToSpeechEngine textToSpeechEngine) {
        if (instance == null) {
